...
if($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["submit"] <> '' && (!isset($_POST["PARAMS_HASH"]) || $arResult["PARAMS_HASH"] === $_POST["PARAMS_HASH"]))
{
	...
	if(check_bitrix_sessid())
	{
		...
		$pattern='/www\.alice\.ru/';
		//if (!preg_match($pattern, $_POST["MESSAGE"])){
			$pattern='/.(com|ru|biz|net|ua|tv|org|gl|me)|https?:/';
			$pattern='/\.(com|ru|biz|net|ua|tv|org|gl|me)/';
			if (preg_match($pattern, $_POST["MESSAGE"]))
				$arResult["ERROR_MESSAGE"][] ='Add direct link not allowed in this form';
		//}	
		//#ALICE			
