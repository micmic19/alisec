...
<div class="bx_mfeedback bx_<?=$arResult["THEME"]?>">
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST">
		...
		<div class="g-recaptcha" data-sitekey="<?=RE_SITE_KEY?>" data-size="compact"></div>
		<input type="submit" name="submit" value="<?=GetMessage("MFT_SUBMIT")?>" class="bx_mfeedback bt_blue">
	</form>
</div>