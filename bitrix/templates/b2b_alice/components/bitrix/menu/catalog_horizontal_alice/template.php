...
<a href="<?=SITE_DIR?>" class="dropdown-button<?if ($arParams["MENU_DROPDOWN_COLLAPSED"]=="Y") echo " dropdown_collapsed"?>"><i class="fa fa-bars fa-sm pull-right"></i>Каталог товаров</a>
	<nav class="bx-top-nav-container<?if ($arParams["MENU_DROPDOWN_COLLAPSED"]=="Y") echo " dropdown_collapsed"?>" id="cont_<?=$menuBlockId?>">
    ...
    <?$color = '#'.$rand[rand(0,15)].$rand[rand(0,15)].$rand[rand(0,15)].$rand[rand(0,15)].$rand[rand(0,15)].$rand[rand(0,15)];?>
				...
				<?if (is_array($arColumns) && count($arColumns) > 100):?>
