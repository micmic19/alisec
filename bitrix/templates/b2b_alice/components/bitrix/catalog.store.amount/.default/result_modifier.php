...
$arFilter = Array("IBLOCK_ID"=>$arParams["SELF_DELIVERY_PLACES_IBLOCK_ID"], "ACTIVE" => "Y");
...
$jsSKUMeasures = array();
$jsStores = array();
$res = CIBlockElement::GetList(array(), $arFilter, false, false,array("ID", "NAME", "PROPERTY_STORE_ID", "PROPERTY_ADDRESS", "PROPERTY_PHONE","PROPERTY_WORK_HOURS", "PROPERTY_PAYMENT_METHOD_CASH", "PROPERTY_PAYMENT_METHOD_CARD","PROPERTY_B2B_NAME"));
while($ob = $res->GetNextElement()){
	...
	$arStores[] = array('ID' => $arItem["ID"],
					'URL' => $storeURL,
					'TITLE' => $arItem["PROPERTY_B2B_NAME_VALUE"],
