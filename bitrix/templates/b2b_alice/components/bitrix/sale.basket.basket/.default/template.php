...
if (strlen($arResult["ERROR_MESSAGE"]) <= 0)
{
	...
	<?Global $USER;Global $APPLICATION;$curPage = $APPLICATION->GetCurPage(true);?>
	<?if (!$USER->IsAuthorized()):?>
	<div class="register-discount">
		<a href="/auth/?register=yes&backurl=<?=$curPage?>">Зарегистрируйтесь и получите скидку<div class = "bx_stick_disc">5%</div></a>
		<div><a href="/info/new-registration-coupon-discount.htm">Подробнее об акции...</a></div>		
	</div>
	<?EndIf?>
