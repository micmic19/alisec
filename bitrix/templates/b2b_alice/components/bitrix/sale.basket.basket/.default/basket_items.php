					...
					<tr id="<?=$arItem["ID"]?>">
						...
						?>
							<td class="control">
								...
								if ($bDeleteColumn):
								?>
									<a class="btn_manage_items" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>"><?=GetMessage("SALE_DELETE")?></a>
								<?
								endif;
								if ($bDelayColumn):
								?>
									<a class="btn_manage_items" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delay"])?>"><?=GetMessage("SALE_DELAY")?></a>
								<?
								endif;
								?>
							</td>
