...
<div class="row"><div class="col-lg-12 bx-filter-title"><?echo GetMessage("CT_BCSF_FILTER_TITLE")?><i class="fa <?if ($arResult["FILTER_ACTIVE"] == true) echo "fa-angle-down"; else echo "fa-angle-up";?>"></i></div></div>
	<div style="display:<?if ($arResult["FILTER_ACTIVE"] == true) echo "none"; else echo "block";?>" class="bx-filter-section container-fluid">
			...
			<div class="row">
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						?>
						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-3<?else:?>col-lg-12<?endif?> bx-filter-parameters-box bx-active">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						continue;
					?>
					<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-3<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						<span class="bx-filter-container-modef"></span>
						...
						<div class="bx-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								default://CHECKBOXES
									?>
									<?foreach($arItem["VALUES"] as $val => $ar):?>
										<div class="checkbox <?if ($arItem["CONTAIN_3_COLS"] == true) echo "col-md-4 col-sm-4"?>">
