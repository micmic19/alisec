...
<a href="/catalog/" class="dropdown-button<?if ($arParams["MENU_DROPDOWN_COLLAPSED"]=="Y") echo " dropdown_collapsed"?>"><i class="fa fa-bars fa-sm pull-right"></i>Каталог товаров</a>
