...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	?><div class="<? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>"><div class="bx_catalog_item_container" id="<? echo $strMainID; ?>">
		<a id="<? echo $arItemIDs['PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL'].'?sku=124133'; ?>" class="bx_catalog_item_images" style="background-image: url('<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>')" title="<? echo $imgTitle; ?>"><?
	...
	if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
	{
		...
		<div class="bx_catalog_item_controls_blockone"><div style="display: inline-block;position: relative;">
			...
			<input type="text" class="bx_col_input" id="<? echo $arItemIDs['QUANTITY']; ?>" name="<? echo $arParams["PRODUCT_QUANTITY_VARIABLE"]; ?>" value="<? echo $arParams['SHOW_PRICE_COUNT'];// #ALICE echo $arItem['CATALOG_MEASURE_RATIO']; ?>">
...
var <? echo $strObName; ?> = new JCCatalogSection(<? echo CUtil::PhpToJSObject($arJSParams, false, true); ?>);
	...
	else
	{
		...
		<div class="bx_catalog_item_controls_blockone">
			<a id="<? echo $arItemIDs['QUANTITY_DOWN']; ?>" href="javascript:void(0)" class="bx_bt_button_type_2 bx_small" rel="nofollow">-</a>
			<input type="text" class="bx_col_input" id="<? echo $arItemIDs['QUANTITY']; ?>" name="<? echo $arParams["PRODUCT_QUANTITY_VARIABLE"]; ?>" value="<? //#ALICE echo $arItem['CATALOG_MEASURE_RATIO']; ?>">
			<a id="<? echo $arItemIDs['QUANTITY_UP']; ?>" href="javascript:void(0)" class="bx_bt_button_type_2 bx_small" rel="nofollow">+</a>
...
<div class="bx_catalog_item_controls_blocktwo">
	...
	?>
		...
		<div class="bx_catalog_item_controls product_store">
			<a id="product_store_<?=$arItemIDs['ID']?>" href="#">Наличие на складах<i class="fa fa-angle-down"></i></a>
		</div>
		<?endif;?>
		<?
			...
			if (!empty($arItem['OFFERS_PROP']))
			{
				...
				if ($arItem['OFFERS_PROPS_DISPLAY'])
				{
					foreach ($arItem['JS_OFFERS'] as $keyOffer => $arJSOffer)
					{
						...
						$arItem['JS_OFFERS'][$keyOffer]['INIT_QUANTITY'] = $arParams['SHOW_PRICE_COUNT'];//#ALICE
					}
				}
				$arJSParams = array(
					'PRODUCT_TYPE' => $arItem['CATALOG_TYPE'],
					...
					'DETAIL_PAGE_URL' => $arItem['DETAIL_PAGE_URL'],//#ALICE
					'SHOW_OLD_PRICE' => ('Y' == $arParams['SHOW_OLD_PRICE']),
					'SHOW_DISCOUNT_PERCENT' => ('Y' == $arParams['SHOW_DISCOUNT_PERCENT']),
					'ADD_TO_BASKET_ACTION' => $arParams['ADD_TO_BASKET_ACTION'],
					'SHOW_CLOSE_POPUP' => ($arParams['SHOW_CLOSE_POPUP'] == 'Y'),
					...
					'VISUAL' => array(
						...
						'STICKER_ID' => $arItemIDs['STICKER_ID'],
						'SECOND_DSC_PERC' => $arItemIDs['SECOND_DSC_PERC'],
						'SECOND_STICKER_ID' => $arItemIDs['SECOND_STICKER_ID'],						
