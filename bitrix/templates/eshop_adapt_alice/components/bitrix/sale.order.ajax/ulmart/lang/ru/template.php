...
$MESS ['SOA_TEMPL_SELF_DELIVERY_BUTTON'] = "Заберу отсюда";
$MESS ['SOA_TEMPL_PROP_INFO'] = "Информация для оплаты и доставки заказа";
$MESS ['SOA_TEMPL_PROP_DELIVERY_INFO'] = "Информация для доставки заказа";
...
$MESS ['SOA_TEMPL_SUM_UNIT'] = "Ед.изм.";
...
$MESS ['SOA_TEMPL_SUM_COMMENTS_PLACEHOLDER'] = "Здесь можно указать особенности раскроя, оверлока, доставки и т.п.";
