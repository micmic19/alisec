...
<?elseif ($arResult["STATUS"] == "N"):?>
	<span id="url_notify_<?=$arParams['NOTIFY_ID']?>"><a class ="bx_big bx_orange bx_bt_button" href="javascript:void(0)" title="<?=GetMessage('NOTIFY_TITLE');?>" onClick="notifyProduct('<?=$arResult["NOTIFY_URL"]?>', <?=$arParams['NOTIFY_ID']?>);"><span class="outlook-icon"></span><?=GetMessage('NOTIFY');?></a></span>
<?elseif ($arResult["STATUS"] == "R"):?>
	<span id="url_notify_<?=$arParams['NOTIFY_ID']?>">
		<a class ="bx_big bx_orange bx_bt_button" href="javascript:void(0)" title="<?=GetMessage('NOTIFY_TITLE');?>" onClick="showNotify(<?=$arParams['NOTIFY_ID']?>)" id="notify_product_<?=$arParams['NOTIFY_ID']?>"><span class="outlook-icon"></span><?=GetMessage('NOTIFY');?></a>
	</span>
<?endif;?>
...
<?
if (isset($arParams["AJAX_POST"]) && $arParams["AJAX_POST"] = "Y")
	die();
?>
