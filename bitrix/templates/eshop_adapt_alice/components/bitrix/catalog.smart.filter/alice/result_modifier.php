...
//#ALICE
		...
		foreach($arItem["VALUES"] as $val => $ar)
			if (strlen($ar["VALUE"]) > $maxlen)
				$maxlen = strlen($ar["VALUE"]);
		if ($maxlen<=5)
			$arItem["COLUMNS"] = "col-md-4 col-xs-4";
		elseif ($maxlen >5 && $maxlen < 9)	
			$arItem["COLUMNS"] = "col-md-6 col-xs-6";
	}
}