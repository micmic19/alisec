...
?>
<?if(!isset($_REQUEST["ajax"])) $this->SetViewTarget("left_sidebar_filter");?>
			...
			<div class="row">
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						?>
						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12 hidden-xs<?endif?> bx-filter-parameters-box bx-active">
						...
						<div class="bx-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								default://CHECKBOXES
									?>
									<?foreach($arItem["VALUES"] as $val => $ar):?>
										<div class="checkbox <?echo $arItem["COLUMNS"];?>">
...
<?if(!isset($_REQUEST["ajax"])) $this->EndViewTarget("left_sidebar_filter");?>
<script>
